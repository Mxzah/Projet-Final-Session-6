...
export const routes: Routes = [
    ...
    { path: 'table/:token', loadComponent: () => import('./pages/table-scan/table-scan.component').then(m => m.TableScanComponent) },
    { path: 'form', loadComponent: () => import('./pages/table-form/table-form.component').then(m => m.TableFormComponent), canActivate: [authGuard] },
    {
        ...
        children: [
            ...
            { path: 'vibes', loadComponent: () => import('./pages/admin-vibes/admin-vibes.component').then(m => m.AdminVibesComponent) },
        ]
    },
