...
export class ComboFormDialogComponent {
    ...
    form = new FormGroup({
        ...
        price: new FormControl<number | null>(null, [Validators.required, Validators.min(0), Validators.max(9999.99)])
    });
    ...
    private dialogRef = inject<MatDialogRef<ComboFormDialogComponent, ComboFormDialogResult>>(MatDialogRef);
    data: ComboFormDialogData = inject(MAT_DIALOG_DATA);
