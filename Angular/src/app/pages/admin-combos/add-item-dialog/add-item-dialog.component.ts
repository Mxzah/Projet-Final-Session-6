...
export class AddItemDialogComponent {
    private dialogRef = inject<MatDialogRef<AddItemDialogComponent, AddItemDialogResult>>(MatDialogRef);
    private data: AddItemDialogData = inject(MAT_DIALOG_DATA);
    private comboItemsService = inject(ComboItemsService);
    ts = inject(TranslationService);
    private errorService = inject(ErrorService);

    items = this.data.items;
    unavailableItemIds = this.data.unavailableItemIds;
