...
const TRANSLATIONS: Record<string, Record<Lang, string>> = {
  ...
  'menu.combosCategory': { fr: 'Combos', en: 'Combos' },
  'menu.comboIncludes': { fr: 'Ce combo inclut :', en: 'This combo includes:' },
  ...
  'menu.sentItems': { fr: 'Déjà commandé', en: 'Already ordered' },
  'menu.newItems': { fr: 'Nouveaux items', en: 'New items' },
  'menu.sentSubtotal': { fr: 'Déjà commandé', en: 'Already ordered' },
  'menu.newSubtotal': { fr: 'Nouveaux items', en: 'New items' },
  'menu.total': { fr: 'Total', en: 'Total' },
  ...
  'admin.combos.descMaxLength': { fr: 'Maximum 255 caractères.', en: 'Maximum 255 characters.' },
  'admin.combos.priceMin': { fr: 'Le prix doit être supérieur à 0.', en: 'Price must be greater than 0.' },
  'admin.combos.priceMax': { fr: 'Le prix ne peut pas dépasser 9999.99 $.', en: 'Price cannot exceed $9999.99.' },
  ...
  'admin.comboItems.detailSubtitle': { fr: 'Gérer les articles de ce combo.', en: 'Manage items in this combo.' },
  'admin.comboItems.add': { fr: 'Ajouter un article', en: 'Add item' },
  ...
  'admin.comboItems.qty': { fr: 'Qté', en: 'Qty' },
  ...
  'tables.qrPreview': { fr: 'Aperçu QR', en: 'QR preview' },
  'tables.qrPreviewHint': { fr: 'Aperçu du QR code tel que vu par les clients.', en: 'QR code preview as seen by clients.' },
  ...
  'form.alreadyOpenOrder': { fr: 'Vous avez déjà une commande en cours', en: 'You already have an open order' },
  'form.alreadyOpenOrderText': { fr: 'Vous ne pouvez pas ouvrir une nouvelle commande tant que la précédente est active.', en: 'You cannot open a new order while your previous one is still active.' },
  'form.goToOrder': { fr: 'Voir ma commande', en: 'Go to my order' },
  'form.guestSingular': { fr: 'personne', en: 'guest' },
  'form.guestsPlural': { fr: 'personnes', en: 'guests' },
  'form.browseMenu': { fr: 'Parcourir le menu', en: 'Browse menu' },
  ...
  'order.status.waiting': { fr: 'En attente', en: 'Waiting' },
  ...
  'order.kitchenProgress': { fr: 'Progression en cuisine', en: 'Kitchen progress' },
  'order.itemsServed': { fr: 'articles servis', en: 'items served' },
  'order.payUnlocksWhenServed': { fr: 'Le paiement sera disponible lorsque tous les articles seront servis.', en: 'Payment will be available once all items are served.' },
  ...
  'reviews.sortOldest': { fr: 'Plus ancien', en: 'Oldest' },
  ...
  'reviews.orderReviewTitle': { fr: 'Évaluer votre commande', en: 'Review your order' },
  'reviews.itemsReviewed': { fr: 'évalué(s)', en: 'reviewed' },
  'reviews.saveReviews': { fr: 'Enregistrer les avis', en: 'Save reviews' },
  'reviews.reviewsSaved': { fr: 'Avis enregistrés avec succès', en: 'Reviews saved successfully' },
  'reviews.reviewed': { fr: 'Évalué', en: 'Reviewed' },
  'reviews.notReviewed': { fr: 'Non évalué', en: 'Not reviewed' },
  'reviews.filterReview': { fr: 'Avis', en: 'Reviews' },
  'reviews.filterAll': { fr: 'Tous', en: 'All' },
  ...
  'admin.vibes.title': { fr: 'Gestion des vibes', en: 'Vibe management' },
  'admin.vibes.subtitle': { fr: 'Créez et gérez les ambiances du restaurant.', en: 'Create and manage restaurant vibes.' },
  'admin.vibes.noVibes': { fr: 'Aucune vibe.', en: 'No vibes.' },
  'admin.vibes.add': { fr: 'Ajouter une vibe', en: 'Add vibe' },
  'admin.vibes.edit': { fr: 'Modifier la vibe', en: 'Edit vibe' },
  'admin.vibes.name': { fr: 'Nom', en: 'Name' },
  'admin.vibes.nameRequired': { fr: 'Le nom est requis.', en: 'Name is required.' },
  'admin.vibes.nameMaxLength': { fr: 'Maximum 50 caractères.', en: 'Maximum 50 characters.' },
  'admin.vibes.nameWhitespace': { fr: 'Le nom ne peut pas être vide.', en: 'Name cannot be blank.' },
  'admin.vibes.color': { fr: 'Couleur (hex)', en: 'Color (hex)' },
  'admin.vibes.colorRequired': { fr: 'La couleur est requise.', en: 'Color is required.' },
  'admin.vibes.colorFormat': { fr: 'Format invalide (#RRGGBB).', en: 'Invalid format (#RRGGBB).' },
  'admin.vibes.image': { fr: 'Image', en: 'Image' },
  'admin.vibes.deleteVibe': { fr: 'Supprimer la vibe', en: 'Delete vibe' },
  'admin.vibes.deleteConfirm': { fr: 'Voulez-vous supprimer', en: 'Do you want to delete' },
  'admin.vibes.archive': { fr: 'Archiver', en: 'Archive' },
  'admin.vibes.archiveConfirm': { fr: 'Cette vibe est utilisée. Elle sera archivée.', en: 'This vibe is in use. It will be archived.' },
  'admin.vibes.archiveWarning': { fr: 'Elle ne sera plus visible pour les clients.', en: 'It will no longer be visible to clients.' },
  'admin.vibes.restoreVibe': { fr: 'Restaurer la vibe', en: 'Restore vibe' },
  'admin.vibes.restoreConfirm': { fr: 'Voulez-vous restaurer', en: 'Do you want to restore' },
  'admin.vibes.deleted': { fr: 'Vibe supprimée', en: 'Vibe deleted' },
  'admin.vibes.restored': { fr: 'Vibe restaurée', en: 'Vibe restored' },
  'admin.vibes.error': { fr: 'Une erreur est survenue.', en: 'An error occurred.' },
};
