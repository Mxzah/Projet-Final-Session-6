...
class OrderLineIndexFailTest < ActionDispatch::IntegrationTest
  ...
  # Test 2: Invalid order id raises RecordNotFound
  test "index with invalid order id returns success false and nil data" do
  ...
  test "index with another client order returns success false" do
