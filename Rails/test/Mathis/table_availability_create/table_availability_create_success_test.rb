...
class TableAvailabilityCreateSuccessTest < ActionDispatch::IntegrationTest
  setup do
    ...
    @fixture_full = availabilities(:table_two_create_full)
    @fixture_open = availabilities(:table_two_create_open)
  ...
  test "create avec tous les champs valides retourne success true" do
    ...
    assert_equal "Table", availability.available_type
    assert_equal @table.id, availability.available_id
