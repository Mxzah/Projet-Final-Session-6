...
class OrderDestroyFailTest < ActionDispatch::IntegrationTest
  ...
  # Test 2: Invalid id returns success false
  test "destroy with invalid id returns success false" do
    delete "/api/orders/999999", as: :json
  ...
  test "destroy another client order returns success false" do
    ...
    delete "/api/orders/#{other_order.id}", as: :json
